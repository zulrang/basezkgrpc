...
_NUMBERPAIR = _descriptor.Descriptor(
  name='NumberPair',
  full_name='NumberPair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='NumberPair.x', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='NumberPair.y', index=1,
...
DESCRIPTOR.message_types_by_name['NumberPair'] = _NUMBERPAIR
...
NumberPair = _reflection.GeneratedProtocolMessageType('NumberPair', (_message.Message,), {
  ...
  '__module__' : 'calculator_pb2'
  # @@protoc_insertion_point(class_scope:NumberPair)
  })
